   ...
   public class ChatServerTest {
     ...
     public class Client {
       ...
       /**
        *  Initializes the client by connecting to the server and setting up writing and reading streams.
        * <p>
       ...
       public String getResponse(char expectedCmd) throws IOException, IndexOutOfBoundsException {
         try {
           ...
           fail(
             e.getMessage() + " " + (int) messageBuffer.charAt(0) + " " + (int) messageBuffer.charAt(1)
           );
         }
